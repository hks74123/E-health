...
class Add_profile1(forms.ModelForm):
    fstname = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control','style':'width : 17rem','placeholder':'Name'}), required=True, max_length=50)
    urmail = forms.EmailField(widget=forms.EmailInput(attrs={'class':'form-control','style':'width : 17rem','placeholder':'Email Id'}), required=True, max_length=50)
    u_nm = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control','style':'width : 17rem','placeholder':'Username'}), required=True, max_length=50)
    
    class Meta():
        model = profile_details
        fields = ['fstname','urmail','u_nm']